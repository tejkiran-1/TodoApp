...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c9223a26-e4fd-4fd9-a3ce-2bd798ff9add
```

> `c9223a26-e4fd-4fd9-a3ce-2bd798ff9add` is the password of the certificate, you can change it to any password you want.
